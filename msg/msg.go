...
func initChallengeChapter() {
	...
	ProtocolProcessor.Register(&pb.SwitchBafflePlateReq{})
	ProtocolProcessor.Register(&pb.SwitchBafflePlateRsp{})
	ProtocolProcessor.Register(&pb.GMReq{})
	ProtocolProcessor.Register(&pb.GMRsp{})
	ProtocolProcessor.Register(&pb.GameCollectPropsReq{})
	ProtocolProcessor.Register(&pb.GameCollectPropsRsp{})
	ProtocolProcessor.Register(&pb.ShopBuyingReq{})
	ProtocolProcessor.Register(&pb.ShopBuyingRsp{})
	ProtocolProcessor.Register(&pb.YesterdayRankReq{})
	ProtocolProcessor.Register(&pb.YesterdayRankRsp{})
	ProtocolProcessor.Register(&pb.ReceiveRankRewardReq{})
	ProtocolProcessor.Register(&pb.ReceiveRankRewardRsp{})
	ProtocolProcessor.Register(&pb.WatchAdvRewardsReq{})
	ProtocolProcessor.Register(&pb.WatchAdvRewardsRsp{})
}
