...
type ChallengeChapterReq struct {
	...
	Stars     int32 `protobuf:"varint,2,opt,name=Stars,proto3" json:"Stars,omitempty"`         //星级
}
...
func (x *ChallengeChapterReq) GetStars() int32 {
	if x != nil {
		return x.Stars
	}
	return 0
...
type ChallengeChapterRsp struct {
	...
	GoldNum        int32           `protobuf:"varint,2,opt,name=GoldNum,proto3" json:"GoldNum,omitempty"`                                                                                                        //金币奖励，这个字段用来弹窗奖励
	CurrGoldNum    int32           `protobuf:"varint,3,opt,name=CurrGoldNum,proto3" json:"CurrGoldNum,omitempty"`                                                                                                //这个是当前金币数量，直接用来覆盖
	ChapterRecords map[int32]int32 `protobuf:"bytes,4,rep,name=ChapterRecords,proto3" json:"ChapterRecords,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"` //通过关卡记录，直接覆盖
}
...
func (x *ChallengeChapterRsp) GetGoldNum() int32 {
	if x != nil {
		return x.GoldNum
	}
	return 0
...
func (x *ChallengeChapterRsp) GetCurrGoldNum() int32 {
	if x != nil {
...
type NoticeChapterRecords struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ChapterRecords map[int32]int32 `protobuf:"bytes,1,rep,name=ChapterRecords,proto3" json:"ChapterRecords,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}

func (x *NoticeChapterRecords) Reset() {
	*x = NoticeChapterRecords{}
	if protoimpl.UnsafeEnabled {
...
func (x *NoticeChapterRecords) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NoticeChapterRecords) ProtoMessage() {}

func (x *NoticeChapterRecords) ProtoReflect() protoreflect.Message {
	mi := &file_pb_game_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NoticeChapterRecords.ProtoReflect.Descriptor instead.
func (*NoticeChapterRecords) Descriptor() ([]byte, []int) {
	return file_pb_game_proto_rawDescGZIP(), []int{4}
}

func (x *NoticeChapterRecords) GetChapterRecords() map[int32]int32 {
	if x != nil {
		return x.ChapterRecords
	}
	return nil
...
var file_pb_game_proto_rawDesc = []byte{
	...
	0x02, 0x70, 0x62, 0x22, 0x49, 0x0a, 0x13, 0x43, 0x68, 0x61, 0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65,
	...
	,
...
var file_pb_game_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_pb_game_proto_goTypes = []interface{}{
	...
	(*NoticeChapterRecords)(nil), // 4: pb.NoticeChapterRecords
	nil,                          // 5: pb.ChallengeChapterRsp.ChapterRecordsEntry
	nil,                          // 6: pb.NoticeChapterRecords.ChapterRecordsEntry
}
var file_pb_game_proto_depIdxs = []int32{
	5, // 0: pb.ChallengeChapterRsp.ChapterRecords:type_name -> pb.ChallengeChapterRsp.ChapterRecordsEntry
	6, // 1: pb.NoticeChapterRecords.ChapterRecords:type_name -> pb.NoticeChapterRecords.ChapterRecordsEntry
...
func file_pb_game_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pb_game_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NoticeChapterRecords); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
